...
{
    public class XeroxController : SpecialPropertiesController
    {
        public XeroxController(DeskContext context, ILogger<XeroxController> logger, IEmailService emailService) : base(context, logger, emailService) { }
        ...
        public async Task<IActionResult> Create([Bind("Description,Priority,ReportedById")] Ticket ticket, [Bind] Xerox specialProperties)
        {
        ...
        {
            _context.Xerox.Add((Xerox)specialProperties);
        }
        ...
        public new async Task<XeroxViewModel> GetSpecialPropertiesViewModel(int id)
        {
            var specialPropertiesVM = new XeroxViewModel
            {
                Ticket = await GetTicket((int)id),
                SpecialProperties = await _context.Xerox
        ...
        public new XeroxViewModel CreateSpecialPropertiesViewModel()
        {
            var specialPropertiesVM = new XeroxViewModel
            {
                Ticket = new Ticket(),
        ...
        /// <param name="specialProperties"></param>
        /// <returns></returns>
        public XeroxViewModel CreateSpecialPropertiesViewModel(Ticket ticket, Xerox specialProperties)
        {
            var specialPropertiesVM = new XeroxViewModel
            {
                Ticket = ticket,
        ...
        {
            return "~/Views/Device/MultiFunctionPrinter/Xerox/";
        }
